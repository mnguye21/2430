...
public class Portfolio {
     ...
     */
    public ArrayList<Investment> search (String symbol, String keywords, String lowprice, String highprice) {
        ...
        switch (typeSearch) {
            ...
            case 100:
                ...
                searchMatches = lowpriceMatches.close();
                break;
            case 1000:
                // Search just high price
                highpriceMatches =  findLowerMatches(highprice);
                searchMatches = highpriceMatches.close();
                break;
            case 11:
    ...
    public ArrayList<Investment> hashSearch(String [] keywords) {
        ...
        for (Integer i: indices) {
            keywordMatches.add(investments.get(i).copy());
        }
