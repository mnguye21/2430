...
public abstract class Investment {
     ...
     */
    public Investment (String symbol, String name, int quantity, double price) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public Investment (Investment other) throws IllegalArgumentException {
    ...
    /**
     * Calculates gain depending on type
     * @param quantity
     * @param price
     * @return
     */
    ...
    /**
     * Calculates bookvalue depending on type
     * @param quantity
     * @param price
     * @return
     */
     ...
     */
    public boolean remove(int quantity, double price) throws IllegalArgumentException {
